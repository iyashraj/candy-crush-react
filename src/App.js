...
const App = () => {
  const [currentColorArrangement, setCurrentColorArrangement] = useState([])
    ...
    const checkForColumnsOfFour = () => {
      for(let i=0; i<39; i++){
        ...
        if(columnOfFour.every(num => currentColorArrangement[num] === decidedColor)){
  ...
  const checkForColumnsOfThree = () => {
    for(let i=0; i<47; i++){
      ...
      if(columnOfThree.every(num => currentColorArrangement[num] === decidedColor)){
  ...
  const checkForRowOfThree = () => {
    for(let i=0; i<64; i++){
      ...
      if(rowOfThree.every(num => currentColorArrangement[num] === decidedColor)){
  ...
  const checkForRowOfFour = () => {
    for(let i=0; i<64; i++){
      ...
      if(rowOfFour.every(num => currentColorArrangement[num] === decidedColor)){
  ...
  },[checkForColumnsOfFour, currentColorArrangement, checkForColumnsOfThree, checkForRowOfFour, checkForRowOfThree ])
